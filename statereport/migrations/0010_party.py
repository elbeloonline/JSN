# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2017-02-27 00:06
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('statereport', '0009_auto_20170226_1830'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('party_role_type_code', models.CharField(max_length=50)),
                ('ptydebt_status_date', models.CharField(max_length=50)),
                ('ptydebt_status_code', models.CharField(max_length=50)),
                ...
                ('party_initials', models.CharField(max_length=50)),
                ('party_street_name', models.CharField(max_length=50)),
                ('party_addt_street_name', models.CharField(max_length=50)),
                ('party_city_name', models.CharField(max_length=50)),
